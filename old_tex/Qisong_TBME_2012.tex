...
%\small{Technical Report, Version 1} \\
...
\subfigure[]{
   \includegraphics[scale=0.4,angle=0] {Recovery_waveform.eps}
   \label{fig:Recovery_waveform}

 }
 \subfigure[]{
   \includegraphics[scale=0.4,angle=0] {Relative_recovery_errors.eps}
...
\subfigure[]{
   \includegraphics[scale=0.25,angle=0] {device.eps}
   \label{fig:device}

 }
 \subfigure[]{
   \includegraphics[scale=0.5,angle=0] {clustering.eps}
   \label{fig:glob_clustering}
 }
 \subfigure[]{
   \includegraphics[scale=0.5,angle=0] {likelihood2.eps}
...
\subfigure[]{
   \includegraphics[scale=.4,angle=0] {posterior_a.eps}
   \label{fig:post_clusters}

 }
 \subfigure[]{
   \includegraphics[scale=.4,angle=0] {posterior_b.eps}
   \label{fig:post_dict}
 }\hspace{-3mm}
 \subfigure[]{
   \includegraphics[scale=.5,angle=0] {posterior_c.eps}
...
\begin{figure}[!htbp]
 \centering
\subfigure[]{
\includegraphics[scale=0.4,angle=0]{figs/single_event1.eps}
\label{fig:single_unit1}}
\subfigure[]{\includegraphics[scale=0.4,angle=0]{figs/single_event2.eps}
\label{fig:single_unit2}} \subfigure[]{
\includegraphics[scale=0.4,angle=0]{figs/global1.eps}
...
\subfigure[]{
   \includegraphics[scale=0.45,angle=0] {Tuning_Parameter1.eps}
   \label{fig:Tuning_Parameter1}
 }
 \subfigure[]{
   \includegraphics[scale=0.45,angle=0] {Tuning_Parameter2.eps}
