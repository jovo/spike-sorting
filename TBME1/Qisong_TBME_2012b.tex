...
\subfigure[]{
   \includegraphics[scale=0.4,angle=0] {figs_new/Recovery_waveform.eps}
   \label{fig:Recovery_waveform}

 }
 \subfigure[]{
   \includegraphics[scale=0.4,angle=0] {figs_new/Relative_recovery_errors.eps}
...
\subfigure[]{
   \includegraphics[scale=0.25,angle=0] {figs_new/device.eps}
   \label{fig:device}

 }
 \subfigure[]{
   \includegraphics[scale=0.5,angle=0] {figs_new/clustering.eps}
   \label{fig:glob_clustering}
 }
 \subfigure[]{
   \includegraphics[scale=0.5,angle=0] {figs_new/likelihood2.eps}
...
\subfigure[]{
   \includegraphics[scale=.4,angle=0] {figs_new/posterior_a.eps}
   \label{fig:post_clusters}

 }
 \subfigure[]{
   \includegraphics[scale=.4,angle=0] {figs_new/posterior_b.eps}
   \label{fig:post_dict}
 }\hspace{-3mm}
 \subfigure[]{
   \includegraphics[scale=.5,angle=0] {figs_new/posterior_c.eps}
...
\begin{figure}[!htbp]
 \centering
\subfigure[]{
\includegraphics[scale=0.4,angle=0]{figs_new/single_event1.eps}
\label{fig:single_unit1}}
\subfigure[]{\includegraphics[scale=0.4,angle=0]{figs_new/single_event2.eps}
\label{fig:single_unit2}} \subfigure[]{
\includegraphics[scale=0.4,angle=0]{figs_new/global1.eps}
...
\subfigure[]{
   \includegraphics[scale=0.45,angle=0] {figs_new/Tuning_Parameter1.eps}
   \label{fig:Tuning_Parameter1}
 }
 \subfigure[]{
   \includegraphics[scale=0.45,angle=0] {figs_new/Tuning_Parameter2.eps}
